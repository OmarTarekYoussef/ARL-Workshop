...
set(MSG_I_FLAGS "-IExercise_three:/home/omar/Task1/src/Exercise_three/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/omar/Task1/src/Exercise_three/msg/UserInfo.msg" NAME_WE)
add_custom_target(_Exercise_three_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "Exercise_three" "/home/omar/Task1/src/Exercise_three/msg/UserInfo.msg" ""
)
...
_generate_msg_cpp(Exercise_three
  "/home/omar/Task1/src/Exercise_three/msg/UserInfo.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/Exercise_three)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/Exercise_three\")")
  # install generated code
  install(
